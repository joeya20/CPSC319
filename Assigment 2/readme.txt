...
4. Compile the java file - i.e. "javac SillySorter.java"
5a. Run the program with the input and output file paths and names, with extensions, as arguments - i.e. "java SillySorter ...\path1\inputFileName.txt ...\path2\outputFileName.txt"
